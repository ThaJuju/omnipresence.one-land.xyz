    ...
    <main className="min-h-screen flex items-center justify-center px-4" style={{ background: 'var(--bg)' }}>
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-semibold tracking-tight" style={{ color: 'var(--text)' }}>Connexion</h1>
          <p className="text-sm mt-1.5" style={{ color: 'var(--text-2)' }}>
            Connectez-vous avec votre compte Discord
          </p>
        </div>

        <div className="rounded-md p-5" style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}>
          <form
            action={async () => {
              'use server'
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-md text-sm font-medium text-white transition-opacity hover:opacity-80"
