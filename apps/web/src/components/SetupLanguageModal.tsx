...
export default function SetupLanguageModal({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-[var(--bg)]/90 backdrop-blur-sm">
      <div className="bg-[var(--surface)] border border-white/[0.07] rounded-2xl p-8 max-w-sm w-full mx-4 shadow-2xl">
        ...
        <div className="space-y-3">
          <button
            onClick={() => choose('fr')}
            disabled={isPending}
            className="w-full flex items-center gap-4 px-5 py-4 rounded-md bg-[var(--bg)] border border-white/[0.07] hover:border-[var(--accent)] hover:bg-[#1a1a40] transition-all text-left group disabled:opacity-50"
          >
